...
- In Windows:
   + For J2ME:
	...
	ex. : java -cp ksoap2-generating-stub-0.1-SNAPSHOT-jar-with-dependencies.jar;"%JAVA_HOME%\lib\tools.jar" ksoap2.generator.Wsdl2J2me -w "http://location-fetcher.appspot.com/LocationFetcherService.wsdl" -g .\generated
   + For Android
