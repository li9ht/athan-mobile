...
public class LocationFetcher {
	@WebMethod
	public Location geoname(String pCityName, String pRegionName,
			String pCountryName, String pLanguage) throws LocationException {
		...
		if (pCountryName != null
				&& HttpPortal.lrtrim(pCountryName).length() > 0) {
		...
		RequestNotFound requestNotFound = new RequestNotFound(pCityName,
				pRegionName, pCountryName, pLanguage);
